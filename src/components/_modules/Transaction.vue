  ...
  <b-container fluid class="transaction-container">
    <div class="this-week">
      ...
      <b-row align-h="between">
        ...
        >
        <b-col cols="4"><p class="transaction-nominal">+Rp.50.000</p></b-col>
      </b-row>
      <b-row align-h="between">
        <b-col cols="7" class="left-detail"
          ><b-col class="navbar-profile">
        ...
        >
        <b-col cols="4"
          ><p class="transaction-nominal-minus">-Rp.149.000</p></b-col
        >
      </b-row>
    </div>
    <!-- ====================THIS MONTH===================== -->
    <div class="this-month">
      <p class="transaction-month">This Month</p>
      <b-row align-h="between">
        <b-col cols="7" class="left-detail"
          ><b-col class="navbar-profile">
            <img
      ...
      <b-row align-h="between">
        <b-col cols="7" class="left-detail"
          ><b-col class="navbar-profile">
            <img
              src="https://dejabar.id/wp-content/uploads/2020/04/images.png"
              alt=""
              class="navbar-image"
            />
            <div class="navbar-detail">
              <p class="navbar-name">Molla TV</p>
              <p class="navbar-phone">Subscription</p>
            </div>
          </b-col></b-col
        >
